...
TEST_CASE("ite.test") {
  ...
  kvList.push_back(
      KeyValue(mkTerm<mpz_class>(3, efac), mkTerm<mpz_class>(0x01, efac), true));
  kvList.push_back(
...
0a: 03  |.|";
  ...
  ite = mk<ITE>(eq1, mkTerm<mpz_class>(0x0, efac), mkTerm<mpz_class>(0x12345, efac));
  ...
  ite = mk<ITE>(eq1, mkTerm<mpz_class>(0x9, efac), mkTerm<mpz_class>(0xaaaa1234, efac));
  ...
  // //---------------
   ...
   ite =
      mk<ITE>(eq1, bv::bvnum(0x6672, 32, efac), bv::bvnum(0x4444, 32, efac));
  ...
  kvList.push_back(KeyValue(mkTerm<mpz_class>(0x45, efac),
                            mkTerm<mpz_class>(0x6672, efac)));
  kvList.push_back(KeyValue(mkTerm<mpz_class>(0x47, efac),
                            mkTerm<mpz_class>(0x4444, efac), true));
  kvList.push_back(KeyValue(mkTerm<mpz_class>(0x77, efac),
                            mkTerm<mpz_class>(0xbbbb, efac)));
...
TEST_CASE("struct.test") {
  ...
  Expr ite = mk<ITE>(eq1, mkTerm<mpz_class>(0x43, efac),
                     mkTerm<mpz_class>(4, efac));
